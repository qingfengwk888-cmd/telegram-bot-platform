async def dispatch_bot_callback(
    *,
    ...
    from app.services.bot_primary_action_callback_dispatch_service import dispatch_bot_primary_action_callback
    ...
    if await dispatch_bot_primary_action_callback(
        callback_query=callback_query,
        platform_bot_token=platform_bot_token,
        from_user=from_user,
        from_id=from_id,
